...
//           value: item.id,
//         }));
//         console.log("Danh sách kho:", formattedData);
...
//       }));
//       console.log("Kho đã chọn:", selectedWarehouse);
//     }
...
//             value={
//               updatedIR.warehouse
//                 ? warehouses.find((item) => item.label === updatedIR.warehouse)?.value
//                 : null
//             }
//           />
...
//                 Tên thuốc: {detail.medicine_name}
//               </Text>
//               <Text style={styles.productDetailText}>
