...
const Medicines = () => {
  return (
    <View style={styles.container}>
      ...
      <Animatable.View animation="fadeInDown" duration={1000} style={styles.searchContainer}>
      ...
      <Animatable.View animation="fadeInUpBig" duration={1000} style={styles.medicineListContainer}>
        <MedicineList />
      </Animatable.View>

      {/* Thêm nút thuốc */}
      <MyButton title={"Thêm thuốc"} style={styles.addButton} />
    </View>
  );
};
